...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'merge_maps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/goro/catkin_ws/src/merge_maps/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/goro/catkin_ws/src/merge_maps/build/devel/lib;/home/goro/turtlebot_ws/devel/lib;/home/goro/catkin_ws/devel/lib;/home/goro/QuanergySystems/catkin_ws/devel/lib;/opt/ros/melodic/lib)
